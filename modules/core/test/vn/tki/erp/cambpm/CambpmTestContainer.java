...
public class CambpmTestContainer extends TestContainer {

    public CambpmTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "vn/tki/erp/cambpm/app.properties",
                // Add this file which is located in CUBA and defines some properties
                // specifically for test environment. You can replace it with your own
                // or add another getOne in the end.
                "test-app.properties");
        initDbProperties();
    }
    ...
    public static class Common extends CambpmTestContainer {

        public static final CambpmTestContainer.Common INSTANCE = new CambpmTestContainer.Common();
